...
Unitcells: template .cif files for slab builder
job_manager: automated large-scale job management scripts
molscontrol: Chenru’s dynamic classifier
python_nn: bond length information for the very first bond length NN (JP’s 2017 Chemical Science paper)
sklearn_models: Chenru’s models for static classification of whether a model is good or bad
